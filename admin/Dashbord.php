...
if(isset($_SESSION['username'])){
    ...
    $cols_user= (getlast('users','*','user_id',$limit_user));
    
      //function lest item from table item------------------------------
      $limit_item = 3;
    $cols_item= (getlast('items','*','item_id',$limit_item));
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Panding Mambers</div>
                      <a href="members.php?page=panding">
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                        <?php echo checkitm('reg_sta' , 'users',0 ) ;?></div></a>
                    </div>
                    <div class="col-auto">
              ...
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                      ...
                      <a href="items.php?do=mange">
                        ...
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                            <?php echo coutrow('item_id' , 'items' ) ;?>
                            </div>
                        </div>
                        <div class="col">
                    ...
                    <div class="col-auto">
                      <i class="fas fa-dollar-sign fa-5x text-gray-300 text-info"></i>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body ">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Total Comment</div>
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                       ...
                       <div class="col-auto">
                      <i class="fas fa-comments fa-5x text-gray-300 text-warning"></i>
                    </div>
                  </div>
                </div>
                </div>
          ...
          <div class="row">
            ...
            <div class="col-xl-6 col-lg-6">
              <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-tags"></i> Last 3 Comment</h6>
