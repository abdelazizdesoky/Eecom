 ...
 <div class="container">
  ...
  <!--nav item-------------------> 
            <div class="collapse navbar-collapse  " id="main-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="categorie.php?do=mange"><?php echo lang('categories')?></a>
                        
                    </li> 
                        
                    <li class="nav-item">
                        <a class="nav-link" href="items.php?do=mange"><?php echo lang('items')?></a>   
                    </li> 
                        
                     <li class="nav-item">
                        <a class="nav-link" href="members.php?do=mange"><?php echo lang('members')?></a>  
                    </li>
                        
                    <li class="nav-item">
                          <a class="nav-link" href="log.php?do=mange"><?php echo lang('statistics')?></a>
                    </li> 
                        
                    <li class="nav-item">
                           <a class="nav-link" href="comments.php?do=mange"><?php echo lang('comment')?></a>
                    </li>
